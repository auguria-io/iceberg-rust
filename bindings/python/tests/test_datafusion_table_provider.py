    ...
    return pa.Table.from_pydict(
        {
            ...
            "timestamp": [
                datetime(2023, 1, 1, 19, 25, 00),  # noqa: DTZ001 - exercise timestamp without a timezone
                None,
                datetime(2023, 3, 1, 19, 25, 00),  # noqa: DTZ001 - exercise timestamp without a timezone
            ],
            # "timestamptz": [
